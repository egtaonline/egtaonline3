  ...
  describe '#profile_space' do
    it 'returns an array of profiles consistent with the current roles' do
      ...
      expect(scheduler.reload.profile_space.sort)
        .to eq(['Role1: 3 A; Role2: 4 C', 'Role1: 1 A, 2 B; Role2: 4 C',
                'Role1: 2 A, 1 B; Role2: 4 C', 'Role1: 3 B; Role2: 4 C',
                'Role1: 2 A, 1 E; Role2: 4 C', 'Role1: 1 A, 2 E; Role2: 4 C',
                'Role1: 1 B, 2 E; Role2: 4 C', 'Role1: 2 B, 1 E; Role2: 4 C',
                'Role1: 3 A; Role2: 3 C, 1 D',
                'Role1: 2 A, 1 B; Role2: 3 C, 1 D',
                'Role1: 1 A, 2 B; Role2: 3 C, 1 D',
                'Role1: 3 B; Role2: 3 C, 1 D'].sort)
    end
  end
end
