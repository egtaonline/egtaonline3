...
ActiveRecord::Schema.define(version: 20130818192416) do
  ...
  add_index 'games', %w(simulator_instance_id name), name: 'index_games_on_simulator_instance_id_and_name', unique: true, using: :btree
  ...
  add_index 'observation_aggs', %w(observation_id symmetry_group_id), name: 'index_observation_aggs_on_observation_id_and_symmetry_group_id', unique: true, using: :btree
  ...
  add_index 'profiles', %w(simulator_instance_id assignment), name: 'index_profiles_on_simulator_instance_id_and_assignment', unique: true, using: :btree
  ...
  add_index 'roles', %w(role_owner_id role_owner_type name), name: 'index_roles_on_role_owner_id_and_role_owner_type_and_name', unique: true, using: :btree
  ...
  add_index 'schedulers', %w(simulator_instance_id name), name: 'index_schedulers_on_simulator_instance_id_and_name', unique: true, using: :btree
  ...
  add_index 'scheduling_requirements', %w(profile_id scheduler_id), name: 'index_scheduling_requirements_on_profile_id_and_scheduler_id', unique: true, using: :btree
  ...
  add_index 'simulators', %w(name version), name: 'index_simulators_on_name_and_version', unique: true, using: :btree
  ...
  add_index 'symmetry_groups', %w(profile_id role strategy), name: 'index_symmetry_groups_on_profile_id_and_role_and_strategy', unique: true, using: :btree
