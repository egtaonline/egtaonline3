...
describe SpecGenerator do
  describe '#generate' do
    ...
    let(:profile){ double(symmetry_groups:
      [symmetry_group1, symmetry_group2, symmetry_group3, symmetry_group4],
    ...
    it 'creates a simulation_spec.json file' do
      ...
      f.should_receive(:write).with(MultiJson.dump({ "assignment" => {
        'B' => ['Shade1', 'Shade1', 'Shade2'], 'S' => ['FPrice', 'FPrice',
        'FPrice', 'SPrice'] }, "configuration" => { fake: 'value' }}))
